...
if(NOT "/home/fcs/UAV/UAV_WS/src/planner/drone_detect/include;/usr/include/eigen3;/usr/local/include/opencv4;/usr/include " STREQUAL " ")
  set(drone_detect_INCLUDE_DIRS "")
  set(_include_dirs "/home/fcs/UAV/UAV_WS/src/planner/drone_detect/include;/usr/include/eigen3;/usr/local/include/opencv4;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'drone_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fcs/UAV/UAV_WS/src/planner/drone_detect/${idir}'.  ${_report}")
    endif()
